...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.t_Ventas.setGeometry(QtCore.QRect(10, 61, 831, 611))
        palette = QtGui.QPalette()
        ...
        self.t_Ventas.setPalette(palette)
        ...
        self.t_Ventas.horizontalHeader().setMinimumSectionSize(10)
...
"border-radius: 14px;")
        ...
        self.fr_botones.setGeometry(QtCore.QRect(10, 680, 831, 51))
        ...
        self.b_Cupon.setGeometry(QtCore.QRect(20, 10, 130, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
...
"border-radius: 14px;")
        ...
        self.b_Inventario.setGeometry(QtCore.QRect(240, 10, 130, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
...
"border-radius: 14px;")
        ...
        self.b_Ticket.setGeometry(QtCore.QRect(460, 10, 130, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
...
"border-radius: 14px;")
        ...
        self.b_Cerrar.setGeometry(QtCore.QRect(680, 10, 130, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
...
"border-radius: 14px;")
        ...
        self.fr_total.setGeometry(QtCore.QRect(850, 320, 151, 411))
...
" }")
        ...
        self.L_importe = QtWidgets.QLabel(self.fr_total)
        self.L_importe.setGeometry(QtCore.QRect(10, 50, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        self.L_importe.setFont(font)
        self.L_importe.setAlignment(QtCore.Qt.AlignCenter)
        self.L_importe.setObjectName("L_importe")
        ...
        self.t_Descuento.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(16)
        font.setBold(False)
...
" }")
        ...
        self.L_Descuento = QtWidgets.QLabel(self.fr_total)
        self.L_Descuento.setGeometry(QtCore.QRect(10, 110, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        self.L_Descuento.setFont(font)
        self.L_Descuento.setStyleSheet("color: rgb(255, 85, 0);")
        self.L_Descuento.setAlignment(QtCore.Qt.AlignCenter)
        self.L_Descuento.setObjectName("L_Descuento")
        self.t_IVA = QtWidgets.QLineEdit(self.fr_total)
        self.t_IVA.setGeometry(QtCore.QRect(10, 310, 130, 30))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(16)
        font.setBold(False)
...
" }")
        ...
        self.L_IVA = QtWidgets.QLabel(self.fr_total)
        self.L_IVA.setGeometry(QtCore.QRect(10, 290, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        self.L_IVA.setFont(font)
        self.L_IVA.setAlignment(QtCore.Qt.AlignCenter)
        self.L_IVA.setObjectName("L_IVA")
        self.t_Total = QtWidgets.QLineEdit(self.fr_total)
        self.t_Total.setGeometry(QtCore.QRect(10, 370, 130, 30))
        palette = QtGui.QPalette()
...
" }")
        ...
        self.L_Total = QtWidgets.QLabel(self.fr_total)
        self.L_Total.setGeometry(QtCore.QRect(10, 350, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.L_Total.setAlignment(QtCore.Qt.AlignCenter)
        self.L_Total.setObjectName("L_Total")
        self.t_Cupon = QtWidgets.QLineEdit(self.fr_total)
        self.t_Cupon.setGeometry(QtCore.QRect(10, 190, 130, 30))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 85, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Text, brush)
        self.t_Cupon.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(16)
        font.setBold(False)
        font.setWeight(50)
        self.t_Cupon.setFont(font)
        self.t_Cupon.setStyleSheet("QLineEdit {\n"
"     border-width: 1px;\n"
"     border-style: solid;\n"
"     border-radius: 5px;\n"
" }")
        self.t_Cupon.setAlignment(QtCore.Qt.AlignCenter)
        self.t_Cupon.setObjectName("t_Cupon")
        self.L_Cupon = QtWidgets.QLabel(self.fr_total)
        self.L_Cupon.setGeometry(QtCore.QRect(10, 170, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        self.L_Cupon.setFont(font)
        self.L_Cupon.setStyleSheet("color: rgb(255, 85, 0);")
        self.L_Cupon.setAlignment(QtCore.Qt.AlignCenter)
        self.L_Cupon.setObjectName("L_Cupon")
        self.t_Subtotal = QtWidgets.QLineEdit(self.fr_total)
        self.t_Subtotal.setGeometry(QtCore.QRect(10, 250, 130, 30))
        palette = QtGui.QPalette()
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Text, brush)
        self.t_Subtotal.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(16)
        font.setBold(False)
        font.setWeight(50)
        self.t_Subtotal.setFont(font)
        self.t_Subtotal.setStyleSheet("QLineEdit {\n"
"     border-width: 1px;\n"
"     border-style: solid;\n"
"     border-radius: 5px;\n"
" }")
        self.t_Subtotal.setAlignment(QtCore.Qt.AlignCenter)
        self.t_Subtotal.setObjectName("t_Subtotal")
        self.L_Subtotal = QtWidgets.QLabel(self.fr_total)
        self.L_Subtotal.setGeometry(QtCore.QRect(10, 230, 130, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        font.setBold(False)
        font.setWeight(50)
        self.L_Subtotal.setFont(font)
        self.L_Subtotal.setStyleSheet("color: rgb(0, 85, 255);")
        self.L_Subtotal.setAlignment(QtCore.Qt.AlignCenter)
        self.L_Subtotal.setObjectName("L_Subtotal")
        self.L9 = QtWidgets.QLabel(self.centralwidget)
        self.L9.setGeometry(QtCore.QRect(940, 730, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        MainWindow.setTabOrder(self.b_Buscar, self.b_Actualizar)
        MainWindow.setTabOrder(self.b_Actualizar, self.b_Eliminar)
        MainWindow.setTabOrder(self.b_Eliminar, self.b_Cancelar)
        MainWindow.setTabOrder(self.b_Cancelar, self.b_Cobrar)
        MainWindow.setTabOrder(self.b_Cobrar, self.b_Cupon)
        MainWindow.setTabOrder(self.b_Cupon, self.b_Inventario)
        MainWindow.setTabOrder(self.b_Inventario, self.b_Ticket)
        MainWindow.setTabOrder(self.b_Ticket, self.b_Cerrar)
        MainWindow.setTabOrder(self.b_Cerrar, self.t_Ticket)
        MainWindow.setTabOrder(self.t_Ticket, self.t_Importe)
        MainWindow.setTabOrder(self.t_Importe, self.t_Descuento)
        MainWindow.setTabOrder(self.t_Descuento, self.t_Cupon)
        MainWindow.setTabOrder(self.t_Cupon, self.t_Subtotal)
        MainWindow.setTabOrder(self.t_Subtotal, self.t_IVA)
        MainWindow.setTabOrder(self.t_IVA, self.t_Total)
        MainWindow.setTabOrder(self.t_Total, self.t_Ventas)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Precio C/U"))
        ...
        self.L_importe.setText(_translate("MainWindow", "Importe"))
        self.t_Descuento.setText(_translate("MainWindow", "$ 0.00"))
        self.L_Descuento.setText(_translate("MainWindow", "Descuento"))
        self.t_IVA.setText(_translate("MainWindow", "$ 0.00"))
        self.L_IVA.setText(_translate("MainWindow", "IVA"))
        self.t_Total.setText(_translate("MainWindow", "$ 0.00"))
        self.L_Total.setText(_translate("MainWindow", "TOTAL"))
        self.t_Cupon.setText(_translate("MainWindow", "$ 0.00"))
        self.L_Cupon.setText(_translate("MainWindow", "Cupón"))
        self.t_Subtotal.setText(_translate("MainWindow", "$ 0.00"))
        self.L_Subtotal.setText(_translate("MainWindow", "Subtotal"))
        self.L9.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt; color:#aaaaaa;\">v 1.7.0</span></p></body></html>"))
