...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.T4.setGeometry(QtCore.QRect(100, 110, 150, 20))
        palette = QtGui.QPalette()
        ...
        self.T3.setGeometry(QtCore.QRect(100, 80, 150, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 160, 245))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        MainWindow.setTabOrder(self.T4, self.b_Entrar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.L5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt; color:#aaaaaa;\">v 1.1.0</span></p></body></html>"))
