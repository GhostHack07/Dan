...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(260, 340)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMaximumSize(QtCore.QSize(260, 340))
        ...
        self.L4.setGeometry(QtCore.QRect(10, 170, 80, 20))
        font = QtGui.QFont()
        ...
        self.D_psw.setGeometry(QtCore.QRect(100, 170, 150, 20))
        palette = QtGui.QPalette()
        ...
        self.b_Cancelar.setGeometry(QtCore.QRect(150, 290, 100, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
        ...
        self.L3.setGeometry(QtCore.QRect(10, 110, 80, 20))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(14)
        ...
        self.D_usuario.setGeometry(QtCore.QRect(100, 110, 150, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 160, 245))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.b_Registrar.setGeometry(QtCore.QRect(10, 290, 100, 30))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(12)
        ...
        self.L6.setGeometry(QtCore.QRect(200, 320, 50, 20))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        self.D_psw_2.setGeometry(QtCore.QRect(100, 200, 150, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 160, 245))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.L5.setGeometry(QtCore.QRect(10, 200, 80, 20))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(14)
        ...
        self.fr_Nivel.setGeometry(QtCore.QRect(9, 230, 241, 51))
        ...
        self.fr_Nivel_2 = QtWidgets.QFrame(self.centralwidget)
        self.fr_Nivel_2.setGeometry(QtCore.QRect(10, 60, 241, 41))
        self.fr_Nivel_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.fr_Nivel_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.fr_Nivel_2.setObjectName("fr_Nivel_2")
        self.b_nuevo = QtWidgets.QRadioButton(self.fr_Nivel_2)
        self.b_nuevo.setGeometry(QtCore.QRect(0, 10, 70, 17))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.b_eliminar = QtWidgets.QRadioButton(self.fr_Nivel_2)
        self.b_eliminar.setGeometry(QtCore.QRect(160, 10, 80, 17))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.b_actualizar = QtWidgets.QRadioButton(self.fr_Nivel_2)
        self.b_actualizar.setGeometry(QtCore.QRect(70, 10, 90, 17))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.L7.setGeometry(QtCore.QRect(10, 140, 80, 20))
        font = QtGui.QFont()
        font.setFamily("Swis721 LtCn BT")
        font.setPointSize(14)
        ...
        self.D_psw_old.setGeometry(QtCore.QRect(100, 140, 150, 20))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 160, 245))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.L6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt; color:#aaaaaa;\">v 2.0.0</span></p></body></html>"))
